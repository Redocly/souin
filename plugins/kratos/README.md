...
This is a distributed HTTP cache module for Kratos based on [Souin](https://github.com/Redocly/souin) cache.  
...
See the [Souin](https://github.com/Redocly/souin) configuration for the full configuration, and its associated [development kratos middleware](https://github.com/Redocly/souin/blob/master/plugins/kratos)  
